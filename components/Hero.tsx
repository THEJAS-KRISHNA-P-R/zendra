  ...
  return (
    <section
      ...
      style={{
        ...
        backgroundColor: 'rgba(24, 120, 222, 1)',
        overflow: 'visible',
        display: 'flex',
      ...
      >
        <div style={{ position: 'relative', width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          ...
          <motion.svg
            ...
            animate={{ rotate: -360 }}
            transition={{ duration: 7.14, ease: 'linear', repeat: Infinity }}
          >
          ...
          <motion.svg
            ...
            viewBox="0 0 321.25 322.864"
            animate={{ rotate: 360 }}
            transition={{ duration: 22.86, ease: 'linear', repeat: Infinity }}
          >
            <defs>
